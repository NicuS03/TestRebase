...
export VERSION ARCHITECTURE DEPENDS MAINTAINER HOMEPAGE DESCRIPTION LONG_DESCRIPTION PACKAGE RELEASE
export DATE=$(date -R)
...
echo "  - ${PACKAGE}_${VERSION}-1_*.deb (binary package)"
echo "  - ${PACKAGE}_${VERSION}-1_*.buildinfo"
echo "  - ${PACKAGE}_${VERSION}-1_*.changes"
